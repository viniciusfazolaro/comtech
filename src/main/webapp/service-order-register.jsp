                ...
                <ol>
                    ...
                    <c:choose>
                        <c:when test="${serviceOrder == null}">
                            <li class="current">Cadastrar OS</li>
                        </c:when>
                        <c:when test="${serviceOrder != null}">
    ...
    <section id="starter-section" class="starter-section section d-flex align-items-center" style="min-height: 100vh;">
        <div class="container d-flex justify-content-center">
            <div class="col-lg-6 col-sm-12">
                <form action="serviceOrderRegister" method="post" class="p-4 border rounded bg-light shadow">
                    ...
                    <div class="mb-2">
                        ...
                        <select class="form-select" name="status" id="status" required>
                            <option value="" ${serviceOrder == null ? "selected" : ""}>Selecione</option>
                    ...
                    <div class="mb-2">
                        ...
                        <select class="form-select" name="clientId" id="clientId">
                            <c:forEach var="client" items="${clients}">
                                <c:if test="${serviceOrder.client.id == client.id}">
                    ...
                    <div class="mb-2">
                        ...
                        <select class="form-select" name="paymentMethodId" id="paymentMethodId">
                            <c:forEach var="method" items="${paymentMethods}">
                                <c:if test="${serviceOrder.paymentmethod.id == method.id}">
