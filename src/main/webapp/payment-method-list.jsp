...
<head>
  ...
  <title>Cadastro de Métodos de pagamento</title>
  ...
  <div class="container-fluid container-xl position-relative d-flex align-items-center">
    ...
    <nav id="navmenu" class="navmenu">
      <ul>
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown3" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Formas de Pagamento
          </a>
  ...
  <div class="page-title" data-aos="fade">
    <div class="container">
      <nav class="breadcrumbs">
        <ol>
          <li><a href="home.jsp">Home</a></li>
          <li class="current">Listar Métodos de Pagamento</li>
        </ol>
      </nav>
      <h1>Listar Métodos de Pagamento</h1>
    </div>
  </div><!-- End Page Title -->
  <section id="starter-section" class="starter-section section" style="min-height: 100vh;">
    <div class="col-lg-6 offset-lg-3 col-sm-12">
      <div id="status"></div>
    </div>
    <div class="container justify-content-center">
      <c:if test="${empty methods}">
        <h2>Nenhum método de pagamento foi cadastrado.</h2>
      </c:if>
            ...
            <tr>
              ...
              <td>
                <span data-bs-toggle="tooltip" data-bs-placement="top" title="Editar">
                    <a class="btn" href="paymentMethodRegister?action=update&method-id=${method.id}">
                ...
                <span data-bs-toggle="tooltip" data-bs-placement="top" title="Excluir">
                    <a type="button" class="btn" data-bs-toggle="modal" data-bs-target="#myModal"
                       data-bs-id="${method.id}" data-bs-name="${method.name}">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Tem certeza que deseja excluir o método de pagamento?</p>
      </div>
...
<script type="text/javascript" src="assets/js/paymentMethod.js"></script>
</body>
