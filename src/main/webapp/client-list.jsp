    ...
    <div class="page-title" data-aos="fade">
        <div class="container">
            <nav class="breadcrumbs">
                <ol>
                    <li><a href="home.jsp">Home</a></li>
                    <li class="current">Listar Clientes</li>
                </ol>
            </nav>
    ...
    <section id="starter-section" class="starter-section section d-flex" style="min-height: 100vh;">
        <div class="container justify-content-center">
            <c:if test="${empty clients}">
                <h2>Nenhum cliente foi cadastrado.</h2>
            </c:if>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span data-bs-toggle="tooltip" data-bs-placement="top" title="Excluir">
                                       ...
                                       data-bs-id="${client.id}" data-bs-name="${client.name}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p id="del-alert">OBS: Ao deletar esse cliente <strong>TODAS</strong> as ordens de serviço desse cliente serão <strong>deletadas</strong>!!!</p>
            </div>
