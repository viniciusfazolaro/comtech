...
<main class="main">
    ...
    <div class="page-title" data-aos="fade">
        <div class="container">
                ...
                <ol>
                    ...
                    <c:choose>
                        <c:when test="${paymentMethod == null}">
                            <li class="current">Cadastrar Método de Pagamento</li>
                        </c:when>
                        <c:when test="${paymentMethod != null}">
                            <li class="current">Atualizar Método de Pagamento</li>
                        </c:when>
                    </c:choose>
                </ol>
            </nav>
            <c:choose>
                ...
                <c:when test="${paymentMethod != null}">
                    <h1>Atualizar Método de Pagamento</h1>
                </c:when>
            </c:choose>
        </div>
    </div><!-- End Page Title -->
    ...
    <div class="container d-flex justify-content-center">
        <div class="col-lg-6 col-sm-12">
            <form action="paymentMethodRegister" method="post" class="p-4 border rounded bg-light shadow">
                <c:choose>
                    <c:when test="${paymentMethod == null}">
                ...
                <div class="mb-2">
                    ...
                    <input type="text" name="name" id="name" class="form-control"
                           required maxlength="50" value="${paymentMethod.name}">
                </div>
